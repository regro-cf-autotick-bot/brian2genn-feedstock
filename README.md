...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/brian2genn-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12680&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/brian2genn-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `brian2genn` can be installed with:

```
conda install brian2genn
```

It is possible to list all of the versions of `brian2genn` available on your platform with:
